...
gcc -isysroot /Applications/Xcode.app/Contents/Developer/Platforms/iPhoneOS.platform/Developer/SDKs/iPhoneOS9.2.sdk -DUNTETHER -arch armv7 offset.c daibutsu/*.c sock_port_2_legacy/*.c -o everuntether -framework IOKit -std=gnu99 -fno-stack-protector -Os
